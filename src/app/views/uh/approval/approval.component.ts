...
import { PengajuanGudangCabangService } from './../../../services/pemohon/pengajuan-gudang-cabang.service';
...
pengajuanList: IPengajuanGudangCabang[] = [];
  ...
  loadPengajuanData(): void {
    this.pengajuanGudangCabangService.getDetailPengajuanByCabangKP(this.currentPage - 1, this.pageSize).subscribe({
