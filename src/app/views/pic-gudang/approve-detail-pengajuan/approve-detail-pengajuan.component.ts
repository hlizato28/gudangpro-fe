...
@Component({
  selector: 'app-approve-detail-pengajuan',
  templateUrl: './approve-detail-pengajuan.component.html',
  styleUrls: ['./approve-detail-pengajuan.component.scss']
})
export class ApproveDetailPengajuanComponent implements OnInit {
  ...
  approval(detail: IDetailPengajuanGudangCabang, app: boolean) {
    ...
    if (detail.idDetailPengajuanGudangCabang !== undefined) {
      this.pengajuanService.approval(detail, app).subscribe({
        next: (response) => {
